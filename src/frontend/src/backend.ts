...
export class Backend implements backendInterface {
    ...
    async getContactMessageByEmail(arg0: string): Promise<ContactMessage> {
        if (this.processError) {
            try {
    ...
    async getVolunteerApplicationByEmail(arg0: string): Promise<VolunteerApplication> {
        if (this.processError) {
            try {
                const result = await this.actor.getVolunteerApplicationByEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
